...
extern void saveSoundfile16(char *name, double *data, double dur) ;
extern void saveSoundfile24(char *name, double *data, double dur) ;
extern double *readSoundfile16(SNDFILE *sf, int frames, int nchan) ;
extern double *readSoundfile24(SNDFILE *sf, int frames, int nchan) ;
extern double *readSoundfile(char *filename, double *dur) ;
extern void saveSoundfile8(char *filename, double **data8, double dur);
extern void save8mono(char *name, double **data8, double dur) ;
