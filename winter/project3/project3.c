...
double *part1A(double *totaldur)
{
	...
	double cflist[] = {0, 103.83, 103.83, 0, 103.83, 103.83, 0, 103.83, 103.83, 0, 103.83, 103.83} ;
	int nTones = 11;
	int nchan = 2 ;

	double durlist[] = {8, 0.1, 0.1, 3, 0.1, 0.1, 3, 0.1, 0.1, 2, 0.1, 0.1} ;
...
double *part4A(double *totaldur)
{
	...
	double cflist[] = {103.83, 110, 0, 324, 213, 0, 103.83, 55, 0, 78} ;
	int nTones = 10;
	int nchan = 2 ;

	double durlist[] = {3, 4, 2, 4, 3, 1, 2, 2, 4, 5} ;
...
int main(void)
{
	double *g, *p1a, *p2a, *p3a, *p3b, *p4a ;
	double *v1, *v2, *v3, *v4, *v5, *v6, *v7, *v8, *v9, *v10, *v11, *v12, *v13, *v14 ;
	double *final ;
	double dur0, dur1, dur2, dur3, dur4, totalDur ;
	double durA ;
	double durB ;
	double durC ;
	double durD ;
	...
	saveSoundfile("sound.wav", final, totalDur) ;
